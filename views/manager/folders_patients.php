    ...
    <main class="dashboard">
        ...
        <form method="GET">
            <div class="dashboard-search">
                ...
                <div class="reset"><a href="patients.php" class="btn-reset"><i class="fas fa-redo"></i></a></div> 
            </div>
        </form>
                    ...
                    <?php if (!empty($patients)) : ?>
                        <?php foreach ($patients as $patient) : ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($patient['firstname']) ?> <?= htmlspecialchars($patient['lastname']) ?></td>
                                <td><?= htmlspecialchars($patient['lastname']) ?></td>
                                <td><?= htmlspecialchars($patient['gender']) ?></td>
                                <td>
                                    <a href="details-patient.php?id=<?= htmlspecialchars($patient['id']); ?>" class="btn-card detail-plus">Détails</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
                ...
                <?php foreach ($patients as $patient) : ?>
                    <div class="card-session">
                        ...
                        <div class="card-actions">
                            <a href="details_patient.php?id=<?= htmlspecialchars($patient['id']); ?>" class="btn-card detail-plus">Détails</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else : ?>
